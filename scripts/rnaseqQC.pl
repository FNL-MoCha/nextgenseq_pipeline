...
print "#Patient\tLibrary\tDiagnosis\tTOTOAL_READS\tPCT_HUMAN\tALIGNED_READS\tPCT_ALIGNED_READS\tPCT_ALIGNED_Q20_BASES\tPCT_RIBOSOMAL_BASES\tPCT_CODING_BASES\tPCT_UTR_BASES\tPCT_INTRONIC_BASES\tPCT_INTERGENIC_BASES\tPCT_MRNA_BASES\tPCT_USABLE_BASES\n";
...
print "$totalReads\t$pct_human\t$aligned_Reads\t$pct_mapped\t";
